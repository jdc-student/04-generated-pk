...
public class CategoryDao {
	...
	public CategoryDao() {
		this.rowMapper = new BeanPropertyRowMapper<>(Category.class);
	}
	...
	public Category findById(int id) {
		return insert.getJdbcTemplate().queryForObject(findById, this.rowMapper, id);
	}

	public List<Category> findByNameLike(String name) {
		return insert.getJdbcTemplate().query(findByNameLike, this.rowMapper, name.toLowerCase().concat("%"));
	}
